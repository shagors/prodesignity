                ...
                {items.length === 0 ? (
                    ...
                    <div className="relative max-w-6xl mx-auto group/rail">
                        <div
                            ...
                            className="flex items-stretch gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scroll-smooth [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
                        >
                            {items.map((item) => (
                                <div
                                    key={item.id}
                                    className="shrink-0 snap-start w-[85vw] sm:w-[26rem] lg:w-[30rem]"
                                >
                                    <PortfolioCard
                                        item={item}
                                        onOpen={setActiveItem}
