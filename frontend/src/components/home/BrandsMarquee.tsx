...
const DEFAULT_BRANDS: Brand[] = [
    { name: "COLLECTIVE AROMAS Co", logo: "/assets/images/brands/1.png" },
    { name: "KOXAL", logo: "/assets/images/brands/2.png" },
    { name: "PHEROMEN", logo: "/assets/images/brands/3.png" },
    { name: "MUSK&CO.", logo: "/assets/images/brands/4.png" },
    { name: "PATÉLLE", logo: "/assets/images/brands/5.png" },
    { name: "عطور كابول", logo: "/assets/images/brands/6.png" },
    { name: "COLLECTIVE AROMAS Co.", logo: "/assets/images/brands/7.png" },
    { name: "GLACIER SUISSE", logo: "/assets/images/brands/8.png" },
    { name: "PAST PARFUMS", logo: "/assets/images/brands/9.png" },
    { name: "BLED BACKHOME", logo: "/assets/images/brands/10.png" },
    { name: "GIVA", logo: "/assets/images/brands/11.png" },
    { name: "TOURI", logo: "/assets/images/brands/12.png" },
    { name: "OLLA", logo: "/assets/images/brands/13.png" },
];

type BrandsMarqueeProps = {
    content?: BrandsCmsContent | null;
};

export default function BrandsMarquee({ content }: BrandsMarqueeProps) {
    const brands: Brand[] =
